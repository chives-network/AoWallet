  ...
  return (
    <Grid container spacing={0}>
        ...
        >
            ...
            <Tab sx={{ textTransform: 'none', my: 0, py: 0}} value={'My Txs'} icon={<Icon fontSize={20} icon='mdi:receipt-text-arrow-left' />} iconPosition="start" label="My Txs" />
            <Tab sx={{ textTransform: 'none', my: 0, py: 0}} value={'Holders'} icon={<Icon fontSize={20} icon='mdi:receipt-text-arrow-left' />} iconPosition="start" label="Holders" />
            <Tab sx={{ textTransform: 'none', my: 0, py: 0}} value={'Received'} icon={<Icon fontSize={20} icon='mdi:receipt-text-arrow-left' />} iconPosition="start" label="Received" />
            <Tab sx={{ textTransform: 'none', my: 0, py: 0}} value={'Received'} icon={<Icon fontSize={20} icon='mdi:receipt-text-arrow-left' />} iconPosition="start" label="Received" />
            </Tabs>
        </Box>
